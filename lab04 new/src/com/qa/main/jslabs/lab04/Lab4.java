...
public class Lab4 {
	...
	public void part1() {
		...
		if (sweetPrice == null || sweetPrice <= 0) { // SweetPrice should now be an int - check if null or 0
			System.out.println("The price has to be greater than zero.");//Warn user if input is bad
			return;
		}
		...
		if (money == null || money <= 0) {// SweetPrice should now be an int - check if null or 0
			System.out.println("The amount of money has to be greater than zero");//Warn user if input is bad
			return;
		}
